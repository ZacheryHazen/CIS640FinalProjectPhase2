...
namespace KSU.CS.Portal.Migrations
{
    ...
    [Migration("20220224221410_InitialMigration")]
            ...
            modelBuilder.Entity("Ksu.Cs.Portal.Areas.Maps.Models.Building", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 228, DateTimeKind.Local).AddTicks(6801),
                            UpdatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 231, DateTimeKind.Local).AddTicks(4125),
                            X = 100ul,
                            Y = 300ul
                        });
                });
            ...
            modelBuilder.Entity("Ksu.Cs.Portal.Areas.Maps.Models.Floor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 4,
                            BuildingId = 1,
                            CreatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(2494),
                            FloorLevel = "Third",
                            FloorMap = "null",
                            UpdatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(2795)
                        },
                        new
                        {
                            Id = 3,
                            BuildingId = 1,
                            CreatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(3211),
                            FloorLevel = "Second",
                            FloorMap = "null",
                            UpdatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(3223)
                        },
                        new
                        {
                            Id = 2,
                            BuildingId = 1,
                            CreatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(3227),
                            FloorLevel = "First",
                            FloorMap = "null",
                            UpdatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(3230)
                        },
                        new
                        {
                            Id = 1,
                            BuildingId = 1,
                            CreatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(3233),
                            FloorLevel = "Basement",
                            FloorMap = "null",
                            UpdatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(3237)
                        });
                });
            ...
            modelBuilder.Entity("Ksu.Cs.Portal.Areas.Maps.Models.Node", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BuildingId = 1,
                            CreatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(3431),
                            UpdatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(3436),
                            X = 600ul,
                            Y = 600ul
                        });
                });
            ...
            modelBuilder.Entity("Ksu.Cs.Portal.Areas.Maps.Models.Door", b =>
                {
                    ...
                    b.Property<bool>("AccessibleEnterance")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            BuildingId = 1,
                            CreatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 231, DateTimeKind.Local).AddTicks(6910),
                            UpdatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 231, DateTimeKind.Local).AddTicks(7218),
                            X = 400ul,
                            Y = 500ul,
                            AccessibleEnterance = false
                        });
                });
            ...
            modelBuilder.Entity("Ksu.Cs.Portal.Areas.Maps.Models.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            BuildingId = 1,
                            CreatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(4472),
                            UpdatedOn = new DateTime(2022, 2, 24, 16, 14, 10, 232, DateTimeKind.Local).AddTicks(4484),
                            X = 500ul,
                            Y = 400ul,
                            FloorId = 4,
                            RoomNumber = "A308"
